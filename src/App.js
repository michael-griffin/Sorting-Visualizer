...
function App() {
  ...
  //For animations: could have a gradient color for bars (maybe a little too fancy)
  //Could have value below bars if there are few enough
  ...
  //For side menu
    ...
    //If I keep buttons, will have to style away most of the 'button-ness'
    //could change to <a> tags or just plain divs, tie an onclick function there
  //For Footer
    //Could add a top header (controls, like demo I saw)
    //add icons for play/pause/speed.
  ...
  let animArr = bubbleSort(barsMain.vals);
  console.log('arr vals is', barsMain.vals);
  console.log('animation list is', animArr);
  ...
  function animateSort(anims) {    
    ...
    for (let i = 1; i < anims.length; i++){
      ...
      if (i == 1) console.log('made it to for loop', i);
      if (i == 2) console.log('made it to for loop', i);
    ...
    //A note: if implementing a pause, can check:
        ...
        <footer className="side-bottom">
          <div className="side-bottom github-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M48.854 0C21.839 0 0 22 0 49.217c0 21.756 
          ...
          <div className="side-bottom min-button">Min B</div>
        </footer>
